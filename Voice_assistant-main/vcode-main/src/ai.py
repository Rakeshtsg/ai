...
import wikipedia
# Set OpenAI API key
openai.api_key = "sk-NMKmNZqjhNpYpgitleZdT3****"
...
conversation.append({'role': 'user',
                     'content': 'chat with me as you be CIT AI from Iron Man, please make a one sentence phrase introducing yourself without saying something that sounds like this chat its already started'})
...
def activate_assistant():
    starting_chat_phrases = ["Yes sir, how may I assist you?",
                             ...
                             "CIT at your service, what do you need?",
                             "CIT here, how can I help you today?",
                             "Yes, what can I do for you today?",
                             "Yes sir, what's on your mind?",
                             "CIT ready to assist, what can I do for you?",
